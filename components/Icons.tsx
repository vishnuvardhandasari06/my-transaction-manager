...
// Memoize all icons as they are pure, stateless components.
...
export const JournalIcon = React.memo(({ className }: { className?: string }) => (
...
export const WhatsAppIcon = React.memo(({ className = "h-5 w-5" }: { className?: string }) => (
...
export const CalculatorIcon = React.memo(() => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
