...
const AddNameDialog: React.FC<AddNameDialogProps> = ({ isOpen, onClose, onSave, existingNames }) => {
    ...
    const handleSave = (e: React.FormEvent) => {
        ...
        if (existingNames.some(n => n.toLowerCase() === trimmedName.toLowerCase())) {
            setError(`The name "${trimmedName}" already exists.`);
            return;
        }
        onSave({ name: trimmedName, phone: phone.trim() });
    };
                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div className="mt-4 space-y-4">
                                    <div>
                                        <label htmlFor="new-name" className="block text-sm font-medium text-text-main/90">Name</label>
                                        <input
                                            type="text"
                                            id="new-name"
                                            value={name}
                                    ...
                                    <div>
                                        <label htmlFor="new-phone" className="block text-sm font-medium text-text-main/90">Phone Number (Optional)</label>
                                        <input
                                            type="tel"
                                            id="new-phone"
                                            value={phone}
...
export default React.memo(AddNameDialog);
